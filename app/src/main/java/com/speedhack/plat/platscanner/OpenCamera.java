...
public class OpenCamera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btCapture = findViewById(R.id.capture_image);
                        ...
                        if (result != PackageManager.PERMISSION_GRANTED) {
                            ...
                            showMessageOKCancel(getString(R.string.permission_message),
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            Toast.makeText(OpenCamera.this, R.string.capture_deny_message, Toast.LENGTH_SHORT).show();
                                        }
                                    });
                            return;
                        } else {
    ...
    private boolean isDeviceSupportCamera() {
        if (getPackageManager().hasSystemFeature(
            ...
            Toast.makeText(OpenCamera.this, getResources().getString(R.string.camera_not_supported), Toast.LENGTH_SHORT).show();
            return false;
        }
                ...
                try {
                    ...
                    if (resultCode == RESULT_OK) {
                        ...
                        if (Build.VERSION.SDK_INT > 22)
                            getImageUrl = ImagePath_MarshMallow.getPath(OpenCamera.this, fileUri);
                        else
...
//                        showCapturedImage();
    ...
    private void transferIntent(){
        if (!getImageUrl.equals("") && getImageUrl != null){
            Intent textGenerator = new Intent(this, TextRecognition.class);
            startActivity(textGenerator);
        }
        else
            Toast.makeText(this, R.string.capture_image_failed, Toast.LENGTH_SHORT).show();
    }
